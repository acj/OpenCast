...
- (void) testDecodeZigZag {
  XCTAssertEqual( 0, decodeZigZag32(0));
  XCTAssertEqual(-1, decodeZigZag32(1));
  XCTAssertEqual( 1, decodeZigZag32(2));
  XCTAssertEqual(-2, decodeZigZag32(3));
  XCTAssertEqual((int32_t)0x3FFFFFFF, decodeZigZag32(0x7FFFFFFE));
  XCTAssertEqual((int32_t)0xC0000000, decodeZigZag32(0x7FFFFFFF));
  XCTAssertEqual((int32_t)0x7FFFFFFF, decodeZigZag32(0xFFFFFFFE));
  XCTAssertEqual((int32_t)0x80000000, decodeZigZag32(0xFFFFFFFF));

  XCTAssertEqual((int64_t) 0, decodeZigZag64(0));
  XCTAssertEqual((int64_t)-1, decodeZigZag64(1));
  XCTAssertEqual((int64_t) 1, decodeZigZag64(2));
  XCTAssertEqual((int64_t)-2, decodeZigZag64(3));
  XCTAssertEqual((int64_t)0x000000003FFFFFFFL, decodeZigZag64(0x000000007FFFFFFEL));
  XCTAssertEqual((int64_t)0xFFFFFFFFC0000000L, decodeZigZag64(0x000000007FFFFFFFL));
  XCTAssertEqual((int64_t)0x000000007FFFFFFFL, decodeZigZag64(0x00000000FFFFFFFEL));
  XCTAssertEqual((int64_t)0xFFFFFFFF80000000L, decodeZigZag64(0x00000000FFFFFFFFL));
  XCTAssertEqual((int64_t)0x7FFFFFFFFFFFFFFFL, decodeZigZag64(0xFFFFFFFFFFFFFFFEL));
  XCTAssertEqual((int64_t)0x8000000000000000L, decodeZigZag64(0xFFFFFFFFFFFFFFFFL));
}
...
- (void) assertReadVarint:(NSData*) data value:(int64_t) value {
  {
    ...
    XCTAssertTrue((int32_t)value == [input readRawVarint32], @"");
  }
  {
    PBCodedInputStream* input = [PBCodedInputStream streamWithData:data];
