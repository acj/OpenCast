...
- (void) testUninitializedException {
    // Was checking for an exception, now looking for a nil return value.
    
    TestRequired *test = [[TestRequired builder] build];
...
- (void) testParseUnititialized {
    // Was checking for exception, now checking for nil;
    TestRequired *item = [TestRequired parseFromData:[NSData data]];
