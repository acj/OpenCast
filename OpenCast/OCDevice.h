 ...
 * @ingroup Discovery
 */
@interface OCDevice : NSObject <NSCopying, NSCoding>
...
/** An array of OCImage objects containing icons for the device. */
@property(nonatomic, copy) NSArray *icons;

/** Designated initializer. Constructs a new OCDevice with the given IP address.
 *
